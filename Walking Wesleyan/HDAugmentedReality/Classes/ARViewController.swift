...
open class ARViewController: UIViewController, ARTrackingManagerDelegate
{
     ...
     */
    open var maxDistance: Double = 0   /* * * * * * default value is 0  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    /* * * * * * * * * * * * Actuallmay I'm not sure changing this made any difference. * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    /* * * * * * THIS GETS SET AGAIN DURING INIT SO THERE'S NOT MUCH POINT SETTING IT HERE * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    fileprivate func filteredAnnotations(_ maxVerticalLevel: Int?, maxVisibleAnnotations: Int?, maxDistance: Double?) -> [ARAnnotation]
    {
        ...
        for nsAnnotation in nsAnnotations
        {
            ...
            {                                                                                           // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                ...
                print("* * * * \(annotation.annotationView?.description)")
                
                
                filteredAnnotations.append(annotation)                                                  // This may be a place where I can add my own
                annotation.active = true                                                    // Logic to show or hide annotations.
                count += 1;                                                             // my idea is to have arrays of annotations for large buildings/locations
            }                                                                       // but have it only display the closest one at a time.
            else                                                    //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            {
                annotation.active = false
            }
